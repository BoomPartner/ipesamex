...
export const pregunatsproductos = [
  ...
  },
  {
    ...
    answer:
      'En nuestro portafolio contamos con  esmaltes alquidálicos de secado normal y secado rapido.',
  },
  {
    id: 3,
    question: '¿Tienen pintura para interiores/exteriores?',
    answer:
      'En IPESA contamos con un portafolio robusto de pinturas vinílicas y esmlates para interiores y exteriores.',
  },
  {
    id: 4,
  ...
  },
  {
    ...
    answer:
      'En IPESA contamos con un amplio portafolio de vinílicas, esmaltes, automotriz, maderas, impermeabilizantes, complementos.',
    enlace: '/productos',
  ...
  },
  {
    ...
    answer:
      'Cada producto cuenta con su  ficha de seguridad y las puedes descargar en la página.',
    enlace: '/productos',
    labelEnlace: 'Ver productos',
    categorie: 'decorativa',
  },
  {
    ...
    answer:
      'En IPESA contamos con un amplio portafolio para madera de la línea CENTURY.',
    enlace: '/productos',
    labelEnlace: 'Ver productos',
    categorie: 'maderas',
  },
  {
    ...
    answer:
      'En IPESA recomendamos para interiores pintura vinilica como: VINTEK, REALTEK y VINIPESA, si buscan pintura para baño o cocina recomendamos esmalte como TROPINAR y TROPIMAR SUR',
  },
  {
    id: 10,
    question:
      '¿Cuál es la durabilidad promedio de sus pinturas para exteriores?',
    answer:
      'La durabilidad de las pinturas vinílicas va de los 3 a los 18 años, en el exterior dependerá de las condiciones climáticas y  exposición directa al sol.',
  },
  {
    id: 11,
    question:
      '¿Qué tipo de preparación de superficie recomiendan antes de aplicar la pintura?',
  ...
  },
  {
    id: 12,
    question:
      '¿Tienen pinturas específicas para diferentes materiales como madera o metal?',
    answer:
      'En IPESA contamos con un amplio portafolio de productos para cada necesidad. Yeso: Portafolio de Vinílicas, Madera: portafolio de CENTURY, Metal: portafolio de esmaltes',
  },
  {
    id: 13,
    question:
      '¿Cuál es la diferencia entre pintura mate, satinada y brillante?',
  ...
  },
  {
    ...
    answer:
      'En IPESA contamos con asesoramiento directo en las tiendas y por medio de los asesores de venta.',
  },
  {
    id: 15,
    question: '¿Cuál es la cobertura aproximada de sus pinturas por litro?',
    answer:
      'En los productos IPESA el rendimiento puede variar según el tipo de producto y desempeño del mismo. Los rendimientos podrás revisarlos en la página.',
  },
  {
    id: 16,
    question: '¿Cómo se determina el tiempo de secado de la pintura?',
    answer:
      'El secado puede cambiar según las condiciones climaticas, sustrato y tipo de producto, existen 2 tiempos de secado, 1.- para aplicar la segunda mano  y 2.- secado al tacto. El secado por cada producto lo puedes consultar en nuestras fichas técnicas.',
  },
  {
    id: 17,
    question:
      '¿Qué medidas de seguridad deben tenerse en cuenta al aplicar pintura?',
    answer: `
  ...
  },
  {
    id: 18,
    question:
      '¿Tienen productos que ayuden a prevenir la formación de moho, hongos y humedad en las paredes?',
  ...
  },
  {
    id: 19,
    question:
      '¿Cómo se debe limpiar y mantener la pintura después de aplicarla?',
    answer:
      'En IPESA sugerimos realizar la limpieza de su pintura Vinílica con un paño seco o húmedo.',
  ...
  },
  {
    id: 21,
    question:
      '¿Pueden mezclar colores personalizados según las necesidades del cliente?',
    answer:
      'En IPESA podemos igualar 3,454 colores y cualquier color que el cliente  requiera con nuestro INFINITE COLOR.',
    labelEnlace: 'Conocer más',
  ...
  },
  {
    id: 23,
    question:
      '¿Ofrecen muestras o pruebas de color antes de comprar grandes cantidades de pintura?',
    answer:
      'En las tiendas especializadas IPESA podrás tener una muestra de color en un chip para identificar el color deseado.',
  },
  {
    id: 24,
    question:
      '¿Cómo puedo obtener asesoramiento sobre mis proyectos de pintura y recubrimientos?',
    answer:
      'En IPESA estamos comprometidos con tus proyectos y podrás recibir asesoría directamente en  tienda.',
    enlace: '/contacto',
  },
...
export const preguntascontacto = [
  ...
  },
  {
    ...
    answer:
      'En IPESA el horario de atención es de 8:00 a 5: 30 de lunes a viernes.',
  },
  {
    id: 32,
  ...
  },
  {
    id: 34,
    question:
      '¿Cuál es la dirección de correo electrónico principal para contactar a la empresa?',
    answer:
      'La dirección de correo electrónico principal para contactarnos es contacto@ipesamex.com.',
  },
  {
    id: 35,
    question: '¿Tienen un formulario de contacto en su sitio web?',
    answer:
      'Sí, tenemos un formulario de contacto, también tenemos un número de WhatsApp y un correo oficial contacto@ipesamex.com.',
  },
  {
    id: 37,
    question:
      '¿Tienen perfiles en redes sociales donde se pueda contactar a la empresa?',
  ...
  },
  {
    id: 38,
    question:
      '¿Tienen algún boletín informativo al que los clientes puedan suscribirse para recibir actualizaciones?',
    answer:
      'En IPESA te invitamos a seguir nuestras redes sociales y adicional por medio de tu vendedor te mantendremos informado.',
    redes: [
      {
        name: 'Facebook',
        url: 'https://www.facebook.com/IPESAPinturasOficial/',
      },
      ...
      {
        name: 'Tiktok',
        url: 'https://www.tiktok.com/@ipesa.pinturas.oficial',
      },
      {
        name: 'Linkedin',
        url: 'https://www.linkedin.com/companys/ipesa-pinturas',
      },
    ],
  },
  {
    ...
    answer:
      'En IPESA te agradecemos el interés y te invitamos a acercarte a tu tienda más cercana, puedes obtener la dirección en nuestra página.',
  },
];
...
export const preguntasdistribuidor = [
  {
    ...
    answer:
      'En la página de IPESA contamos con un apartado de contacto donde podrás dejarnos tus datos y un especialista se pondrá en contacto contigo.',
  },
  {
    id: 42,
    question:
      '¿Tienen una liga para poder dejar mis datos si quiero ser distribuidor?',
    answer:
      'En la página de IPESA contamos con un apartado de contacto donde podrás dejarnos tus datos y un especialista se pondrá en contacto contigo.',
  },
  {
  ...
  },
  {
    id: 44,
    question:
      '¿Brindan apoyo técnico y asesorías de capacitación a los distribuidores?',
    answer:
      'En IPESA estamos comprometidos en todo momento con la asesoría personalizada a todos nuestros distribuidores.',
  },
  {
    id: 45,
    question:
      '¿En cualquier estado de la república pueden afiliarse como distribuidores?',
    answer:
      'En la página de IPESA contamos con un apartado de contacto donde podrás dejarnos tus datos y un especialista se pondrá en contacto contigo.',
  },

  {
    id: 48,
    question:
      '¿Cómo se realizan los pedidos y cómo se gestionan las entregas para los distribuidores?',
    answer:
      'En IPESA el cliente es nuestra prioridad, nuestras entregas son ágiles y oportunas, los pedidos y entregas los podrás monitorear con tu vendedor.',
  },
  {
    id: 49,
    question:
      '¿Cómo los distribuidores pueden resolver dudas o contingencias con ustedes?',
...

  {
    ...
    answer:
      'En IPESA contamos con un plan de rotulación de fachadas que dependerá del tipo de cliente, para mayor información acércate con tu vendedor.',
  },
  {
    id: 51,
    question: '¿Es necesario tener un local primero para ser distribuidor?',
    answer:
      'En IPESA buscamos clientes interesados en el modelo de negocio y puede ser con local establecido o en conjunto buscar un punto estratégico, para mayor información puedes comunicarte al número 5555691855.',
  },
];

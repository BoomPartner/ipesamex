...
const ProductoSelected = ({ valor }) => {
  ...
  useEffect(() => {
    if (articulo) {
      gsap.fromTo(
        '.imagen-producto .producto-selected',
        {
          x: '-100%',
          opacity: 0,
        },
  ...
  return (
    <section className={`w-full py-24`} style={backgroundStyle}>
        ...
        <>
          <div
            className={`w-full h-full ${
              windowWidth < 1000 ? 'block' : 'flex justify-center items-center'
            }`}
          >
            {/* Enlace de retorno */}
            <div className="h-full flex items-center px-4 hover:shadow-xl">
              <div className="w-full">
                ...
                >
                  <FontAwesomeIcon
                    icon={faAngleLeft}
                    className="font-awesome-icon zoom-enlace"
                    size="2xl"
                  ></FontAwesomeIcon>
                </Link>
              </div>
                ...
                {articulo.tipo ? (
                  <div className="imagen-producto">
                    <Image
                      ...
                      height={180}
                      alt="imagen"
                      className="producto-selected"
                    ></Image>{' '}
                  </div>
                ) : articulo.imagen_prd ? (
                  <div className="imagen-producto">
                    <Image
                      src={articulo.imagen_prd}
                      width={400}
                      height={500}
                      alt="imagen"
                      className="producto-selected"
            ...
            <div className="w-full p-5 lg:p-10">
              ...
              <Typography
                ...
                variant="h3"
                color="gray"
                className="uppercase font-semibold relative mb-5 card-animate"
              >
                {' '}
                {articulo.name}
                {articulo.registro ? (
                  <span style={{ fontSize: '14px' }} className="absolute top-0">
                    {articulo.registro}
                  </span>
                ) : null}
                {articulo.name2 ? (
                  <span className="ml-2">{articulo.name2}</span>
                ) : null}
              </Typography>
              ...
              <section className="mb-10 producto-animate2">
                ...
                <div className="w-full md:w-[80%] mt-1">
                  ...
                  {articulo.description2
                    ? articulo.description2?.map((element, index) => (
                        <Typography
                          as={'p'}
                          key={index}
                          className="mt-5 mb-2"
                      ...
                      {articulo.promedio ? (
                        <div className="w-full mt-2 flex items-center">
                          <div
                            className={`${
                              windowWidth < 1816 ? '' : ''
                            } flex items-center border p-4 rounded-full cursor-pointer zoom-producto`}
                  ...
                  {articulo.acabados ? (
                    <div className="w-full md:w-[30%]">
                      ...
                      <Typography
                        ...
                        color="gray"
                      >
                        {articulo.acabados} <br />
                        {articulo.acabados2 ? articulo.acabados2 : null}
                      </Typography>
                    </div>
                  ) : null}
              ...
              <div className="w-full md:w-[80%] mt-8 md:grid-cols-2 grid grid-cols-1 gap-3 card-animate4">
                {articulo.ficha &&
                  (windowWidth < 800 || browser == 'Mac' ? (
                    ...
                    <div
                      className="w-full flex items-center cursor-pointer zoom-producto"
                ...
                {articulo.fichas_colores &&
                  (windowWidth < 800 || browser == 'Mac' ? (
                    ...
                    <div
                      className="w-full flex items-center cursor-pointer zoom-producto"
                      onClick={() => handleModalFicha(articulo.fichas_colores)}
                    >
                      <div className="">
                        <FontAwesomeIcon
                          icon={faSwatchbook}
                ...
                {articulo.seguridad &&
                  (windowWidth < 800 || browser == 'Mac' ? (
                    <div
                      className="w-full rounded-lg -ml-2 text-gray-600 flex items-center uppercase zoom-producto"
                      style={{
                        fontSize: '14px',
                        fontWeight: 'normal',
                        padding: '9px',
              ...
              {color.map((item, index) => (
                <div key={index} className="mt-4">
                  {item.color_imagen ? (
                    ...
                    <div
                      key={index}
                      className={`w-[10rem] h-[10vh] shadow-2xl rounded-xl mx-auto`}
                      style={{ background: item.color }}
                    ></div>
                  )}

                  <div className="text-gray text-center mt-4">{item.name}</div>
                  <div className="text-gray text-center">{item.codigo}</div>
                </div>
              ))}
            </div>
          </DialogBody>
            ...
            <div className="porarriba pdf-container flex justify-center">
              {pdfVisible ? ( // Si el PDF es visible, muestra el objeto PDF
                ...
                <div>
                  ...
                  >
                    El PDF no se puede mostrar. Por favor, descárguelo.
                  </Typography>
                  <a
                    href={ficha}
                    download
      ...
      <Dialog
        ...
        handler={handleOpen3}
        size="lg"
        className="mt-24 porarriba bg-[] w-full"
      >
      ...
      >
        ...
        {litros && (
          <div className="w-full flex">
            ...
            <div className="ml-5">
              <Typography as={'p'} variant="paragraph" className="text-lg">
        ...
        <Typography as={'h5'} variant="h5" className="mt-5">
          ¡Importante!
        </Typography>

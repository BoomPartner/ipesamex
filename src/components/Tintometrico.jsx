...
const SistemaTintometrico = () => {
    ...
    return (
        <div className='block'>
            ...
            <div className="" style={{
                backgroundImage: `url(/tintometrico/01.webp)`, backgroundSize: 'cover',
                backgroundPosition: 'center', width: '100%', paddingBottom: "40%"
            }}>
                <div className="w-full flex justify-center" style={{ textAlign: 'center', color: 'white', paddingTop: '50px' }}>
                    <div className={`${windowWidth < 460 ? "w-[70%]" : "w-[60%]"}`}>
                        ...
                        <Button
                            ...
                            onClick={() => scrollToElement('tintometrico')}>Conocer más</Button>
                    </div>
                </div>
            ...
            <div className="backgroundTips">
                ...
                <div id='section1' className={`w-full ${windowWidth < 1090 ? "" : "flex"} overflow-hidden`}>

                    <div className="w-full p-10 flex flex-col items-center justify-center">

                        <div className="">
                            <Typography as={'h1'} variant={windowWidth < 900 ? "h3" : "h1"} className='efectotexto1 mt-24 uppercase'>
                                ¿Qué te ofrecemos?
                            </Typography>
                        </div>
                        ...
                        <div className="">
                            ...
                            <Typography as={'h4'} variant='h4' className='efectotexto2 mt-24'>
                                Equipo operado a través de una computadora que posee un completo software de igualación de color.
                            </Typography>
                        </div>

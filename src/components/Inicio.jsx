    ...
    >
            ...
            {categorias?.map((item, index) => (
              <>
                ...
                >
                  ...
                  >
                    <div
                      className="bg-black bg-opacity-0 hover:bg-opacity-50 hover:text-[#c89919] transform duration-300 cursor-pointer"
                      style={{
                        objectFit: 'cover',
                        width: '100%',
                        height: '100%',
      ...
      >
        <div className="banenrDecorativa">
          <div className="w-full border fex justify-center">
            <Image
              placeholder="blur"
              blurDataURL="/articulos/automotriz/base_color.png"
              src={'/articulos/automotriz/base_color.png'}
              className="bote-automotivo w-[15%] absolute z-10 top-[37%] left-[44%]"
              width={1000}
              height={1000}
              alt="bote"
            ...
            <Image
              placeholder="blur"
              blurDataURL="/principal/automotivo/burbuja.webp"
              src={'/principal/automotivo/burbuja.webp'}
              width={1200}
              height={1200}
              className="burbuja-grande absolute inset-0 m-auto w-[65%]"
              alt="burbuja"
            ></Image>
            <Image
              placeholder="blur"
              blurDataURL="/principal/automotivo/aros.webp"
              src={'/principal/automotivo/aros.webp'}
              width={1200}
              height={1200}
              className={`aros absolute top-[43%] left-[26%] w-[50%]`}
              alt="aros"
            ></Image>
            <Image
              placeholder="blur"
              blurDataURL="/principal/automotivo/1.png"
              src={'/principal/automotivo/1.png'}
              width={285}
              height={285}
              className={`burbuja1 absolute top-[60%] right-[10%] w-[17%]`}
              alt="automotriz"
            ></Image>
            <Image
              placeholder="blur"
              blurDataURL="/principal/automotivo/2.png"
              src={'/principal/automotivo/2.png'}
              width={285}
              height={285}
              className={`burbuja2 absolute top-[40%] right-[17%] w-[15%]`}
              alt="automotriz"
            ></Image>
            <Image
              placeholder="blur"
              blurDataURL="/principal/automotivo/3.png"
              src={'/principal/automotivo/3.png'}
              width={285}
              height={285}
              className={`burbuja3 absolute top-[20%] right-[24%] w-[15%]`}
              alt="automotriz"
            ></Image>

            <Image
              placeholder="blur"
              blurDataURL="/principal/automotivo/4.png"
              src={'/principal/automotivo/4.png'}
              width={285}
              height={285}
              className={`burbuja4 absolute top-[8%] right-[38%] w-[18%]`}
              alt="automotriz"
            ></Image>

            <Image
              placeholder="blur"
              blurDataURL="/principal/automotivo/5.png"
              src={'/principal/automotivo/5.png'}
              width={285}
              height={197}
              className={`burbuja5 absolute top-[20%] left-[25%] w-[15%]`}
              alt="automotriz"
            ></Image>
            <Image
              placeholder="blur"
              blurDataURL="/principal/automotivo/6.png"
              src={'/principal/automotivo/6.png'}
              width={285}
              height={197}
              className={`burbuja6 absolute top-[40%] left-[15%] w-[18%] `}
              alt="automotriz"
            ></Image>
            <Image
              placeholder="blur"
              blurDataURL="/principal/automotivo/7.png"
              src={'/principal/automotivo/7.png'}
              width={285}
              height={197}
              className={`burbuja7 absolute top-[60%] left-[13%] w-[15%] `}
              alt="automotriz"
            ></Image>
          </div>

          <div
            className={`flex justify-center gap-5 inline-block w-full z-10 absolute bottom-5 
                    left-1/2 transform -translate-x-1/2 text-white botones-colorcril`}
          >
            <div
              className={`bg-white text-black rounded-lg text-center agrande uppercase p-2 ${
                windowWidth < 600 ? '' : 'px-10'
              }`}
            >
              <Link
                href={'/productos'}
                onClick={() => handleCategoriaInicio('automotriz')}
                style={{ fontSize: windowWidth < 720 ? '12px' : '15px' }}
      ...
      <section id="clientes" className="overflow-hidden">
        <div className="w-full">
          ...
          <div
            className={`grid ${
              windowWidth < 1100 ? 'grid-cols-1' : 'grid-cols-3'
            } gap-5 p-10`}
          >
            {consumidores?.map((item, index) => (
              <div
                key={index}
                className={`opacity-0 shadow-xl transform duration-500 hover:scale-110 group ${
                  isElementVisible2 ? item.clase : ''
                }`}
                style={{
                  position: 'relative',
                  width: '100%',
                ...
                >
                  <div className="z-10 flex items-center h-full text-white bg-black bg-opacity-0 px-10 hover:bg-opacity-50 transform duration-500">
                    <div className="">
                      ...
                      >
                        <Typography as={'p'} variant="small" color="white">
                          {item.description}
                        </Typography>
                      </div>
                    </div>
      ...
      <section id="colorvida">
        <div className="w-full">
          <div
            className={`w-full ${windowWidth < 950 ? '' : 'flex items-center'}`}
          >
            <div className="w-full p-10">
              <div className="w-full mb-10">
                <Typography
                  as={'h1'}
                  variant={`${windowWidth < 1280 ? 'h3' : 'h1'}`}
                  className={`uppercase ${isElementVisible3 ? 'arriba' : ''}`}
                >
                  Experimenta el color en tu vida
                </Typography>
              </div>
              <Typography
                as={'h3'}
                variant="h3"
                className={`${isElementVisible3 ? 'arriba2' : ''}`}
              >
                <strong>IPESA®</strong> transforma tu próximo proyecto en una
                realidad vibrante, ofreciéndote herramientas de color avanzadas
                para elegir los tonos exactos que materializarán tu visión
                creativa.
              </Typography>
              <div
                className={`w-full grid  ${
                  windowWidth < 500 ? '' : 'grid-cols-2'
                }  gap-5`}
              >
                <Link
                  href={'/colores'}
                  className={`mt-10 bg-[#c50411] text-center p-2 rounded-lg text-white font-semibold uppercase ${
                    isElementVisible3 ? 'arriba4' : ''
                  }`}
                >
                  Gama de colores
                </Link>
            ...
            <div className="w-full">
              <Image
                ...
                height={1000}
                alt="color-vida"
                className={`w-full  ${isElementVisible3 ? 'arriba2' : ''}`}
              ></Image>
            </div>
          </div>
        </div>
      ...
      <section id="calculador">
        ...
        >
          <div className="w-full flex justify-center">
            <Image
              placeholder="blur"
              blurDataURL='/principal/calculador.png"'
              src={'/principal/calculador.png'}
              className=""
              width={630}
              height={670}
              alt="mano"
          ...
          <div className="w-full p-10">
            <div className="w-full mb-10">
              <Typography
                as={'h3'}
                variant={`${windowWidth < 1280 ? 'h3' : 'h2'}`}
                className={`uppercase `}
              >
                ¿No sabes cuántos litros necesitas?
              </Typography>
            </div>
            <Typography as={'h5'} variant="h5" className={``}>
              Puedes ocupar nuestro calculador con cualquiera de nuestros
              productos.
            </Typography>
            ...
            >
              <Button
                className={`mt-10 bg-[#c50411] text-center p-3 rounded-lg text-white 
                                    font-semibold`}
      ...
      <section
        className={`bg-[url('/principal/distribuidor.webp')] bg-cover bg-center`}
      >
        <div className="w-full md:flex items-center">
          <div
            className={`w-full relative p-5 ${
              windowWidth < 1212 ? 'bg-[#dfe3e6]' : 'backDist'
            }`}
            id="distribuidor"
          >
            <div
              className={
                windowWidth < 1212
                  ? 'w-[100%] p-5'
                  : 'w-[50%] p-10 transition-all duration-500'
              }
            >
              <Typography
                variant={windowWidth < 950 ? `h3` : 'h1'}
                color="black"
                className=""
              >
                DISTRIBUIDOR IPESA®
              ...
              <Typography
                ...
                className={`mt-10 text-left ${
                  isElementVisible5 ? 'arriba' : ''
                }`}
                style={{ fontSize: '16px' }}
              >
                Únete a nuestra red de distribuidores, en IPESA® valoramos la
                calidad, la confianza y colaboración mutua, como distribuidor de
                nuestra marca tendrás acceso a una amplia gama de productos de
                alta calidad, así como a nuestro respaldo y apoyo continuo para
                alcanzar tus metas comerciales. Además, ofrecemos condiciones
                comerciales competitivas, financiamientos y herramientas de
                venta.
              </Typography>
              <Typography
                variant={'small'}
                color="black"
                className={`mt-10 text-left ${
                  isElementVisible5 ? 'arriba2' : ''
                }`}
                style={{ fontSize: '16px' }}
              >
                Si estás interesado en formar parte de nuestra familia de
                distribuidores IPESA® no dudes en ponerte en contacto con
              ...
              >
                ¡Conviértete en un socio exitoso con una gran compañía en
                expansión!
              </Typography>
              ...
              >
                <Link
                  href={'/contacto'}
                  onClick={handleContacto('distribuidor')}
                  className={`mt-10 bg-[#c50411] text-center p-2 rounded-lg text-white font-semibold uppercase ${
                    isElementVisible3 ? 'arriba4' : ''
                  }`}
                >
              ...
              <div
                className={` mt-10 ${
                  windowWidth < 1212 ? 'w-full' : 'w-[80%]'
                }`}
              >
                <Image
                  placeholder="blur"
                  blurDataURL="/principal/tienda.png"
                  src={'/principal/tienda.png'}
                  className={`w-full ${isElementVisible5 ? 'arriba4' : ''}`}
                  width={1000}
                  height={1000}
                  alt="Tienda"
                ></Image>
      ...
      >
        ...
        <div className="mb-10">
          ...
          <Input
            variant="standard"
            placeholder="Area total a pintar"
            size="lg"
          ...
          <div className="w-full flex">
            ...
            <div className="ml-5">
              <Typography variant="paragraph" className="text-lg">
                ...
                litros para cubrir{' '}
                <strong className="text-xl font-bold">{area}</strong> metros
                cuadrados.
              </Typography>
            </div>
          </div>
        ...
        <div className="w-full flex justify-center mt-10">
          <Button
            className="bg-[#c50411] zoom-producto text-white"
            color="white"
            onClick={handleCalcularLitros}
          >
            Calcular
          </Button>
          <Link
        ...
        <Typography className="" variant="paragraph">
          El rendimiento puede variar según el tipo de acabado y método de
          aplicación.
        </Typography>
      </Drawer>
    </div>
